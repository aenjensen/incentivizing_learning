...
p.adjust(
  c(
    coeftest(ols_full_sample_total_time, vcov. = vcovHC(ols_full_sample_total_time, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(ols_full_sample_total_time, vcov. = vcovHC(ols_full_sample_total_time, type = "HC3"))["mabaegg", "Pr(>|t|)"],
    ...
    coeftest(reach_sample_total_time, vcov. = vcovHC(reach_sample_total_time, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(reach_sample_total_time, vcov. = vcovHC(reach_sample_total_time, type = "HC3"))["mabaegg", "Pr(>|t|)"],
    linearHypothesis(reach_sample_total_time, "mabaprescribed = mabaoptional", vcov. = vcovHC(reach_sample_total_time, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(short_term_total_time, vcov. = vcovHC(short_term_total_time, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(short_term_total_time, vcov. = vcovHC(short_term_total_time, type = "HC3"))["mabaegg", "Pr(>|t|)"],
    linearHypothesis(short_term_total_time, "mabaprescribed = mabaoptional", vcov. = vcovHC(short_term_total_time, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(long_term_total_time, vcov. = vcovHC(long_term_total_time, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(long_term_total_time, vcov. = vcovHC(long_term_total_time, type = "HC3"))["mabaegg", "Pr(>|t|)"],
...
p.adjust(
  c(
    coeftest(ols_full_sample_total_work, vcov. = vcovHC(ols_full_sample_total_work, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(ols_full_sample_total_work, vcov. = vcovHC(ols_full_sample_total_work, type = "HC3"))["mabaegg", "Pr(>|t|)"],
    ...
    coeftest(reach_sample_total_work, vcov. = vcovHC(reach_sample_total_work, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(reach_sample_total_work, vcov. = vcovHC(reach_sample_total_work, type = "HC3"))["mabaegg", "Pr(>|t|)"],
    linearHypothesis(reach_sample_total_work, "mabaprescribed = mabaoptional", vcov. = vcovHC(reach_sample_total_work, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(short_term_total_work, vcov. = vcovHC(short_term_total_work, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(short_term_total_work, vcov. = vcovHC(short_term_total_work, type = "HC3"))["mabaegg", "Pr(>|t|)"],
    linearHypothesis(short_term_total_work, "mabaprescribed = mabaoptional", vcov. = vcovHC(short_term_total_work, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(long_term_total_work, vcov. = vcovHC(long_term_total_work, type = "HC3"))["mabaxp", "Pr(>|t|)"],
    coeftest(long_term_total_work, vcov. = vcovHC(long_term_total_work, type = "HC3"))["mabaegg", "Pr(>|t|)"],
...
p.adjust(
  c(
    coeftest(D1_logit_full, vcov. = vcovHC(D1_logit_full, type = "HC3"))["mabaxp", "Pr(>|z|)"],
    coeftest(D1_logit_full, vcov. = vcovHC(D1_logit_full, type = "HC3"))["mabaegg", "Pr(>|z|)"],
    linearHypothesis(D1_logit_full, "mabaprescribed = mabaoptional", vcov. = vcovHC(D1_logit_full, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(W0_logit_full, vcov. = vcovHC(W0_logit_full, type = "HC3"))["mabaxp", "Pr(>|z|)"],
    coeftest(W0_logit_full, vcov. = vcovHC(W0_logit_full, type = "HC3"))["mabaegg", "Pr(>|z|)"],
    linearHypothesis(W0_logit_full, "mabaprescribed = mabaoptional", vcov. = vcovHC(W0_logit_full, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(D1_logit_reach, vcov. = vcovHC(D1_logit_reach, type = "HC3"))["mabaxp", "Pr(>|z|)"],
    coeftest(D1_logit_reach, vcov. = vcovHC(D1_logit_reach, type = "HC3"))["mabaegg", "Pr(>|z|)"],
    linearHypothesis(D1_logit_reach, "mabaprescribed = mabaoptional", vcov. = vcovHC(D1_logit_reach, type = "HC3"))[["Pr(>F)"]][2],
    
    coeftest(W0_logit_reach, vcov. = vcovHC(W0_logit_reach, type = "HC3"))["mabaxp", "Pr(>|z|)"],
    coeftest(W0_logit_reach, vcov. = vcovHC(W0_logit_reach, type = "HC3"))["mabaegg", "Pr(>|z|)"],
